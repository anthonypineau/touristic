...
//                $objetLu = OffreDAO::getOneById($unEtab->getId(), $unTypeCh->getId());
        ...
        // Test n°6
        echo "<h3>6- getNbChambresOffertesParTypePourUnEtab</h3>";
        try {
            $tab = OffreDAO::getNbChambresOffertesParTypePourUnEtab($idEtab);
            var_dump($tab);
        } catch (Exception $e) {
            echo "<h4>*** échec de la requête ***</h4>" . $e->getMessage();
        }
        ...
        // Test n°7
        echo "<h3>7- getNbChambresOffertesParType</h3>";
        try {
            $tab = OffreDAO::getNbChambresOffertesParEtabParType();
            var_dump($tab);
        } catch (Exception $e) {
            echo "<h4>*** échec de la requête ***</h4>" . $e->getMessage();
        }
