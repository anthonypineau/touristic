...
class AttributionDAO {
    ...
    /**
     * Retourne le nombre total de chambres attribuées pour l'offre (idEtab, idTypeChambre),
     * tous groupes confondus
     * @param string $idEtab
     * @param string $idTypeChambre
     * @return int nombre de chambres si au moins une attribution ; =0 par défaut
     */
